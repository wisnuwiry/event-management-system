...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
  ...
  <a href="/" class="cursor-pointer">
    <x-application-logo class="flex items-center space-x-3 rtl:space-x-reverse h-10 fill-current text-gray-800 dark:text-gray-200"/>
  </a>
      ...
      <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
        ...
        <ul class="py-2" aria-labelledby="user-menu-button">
          ...
          <form method="POST" action="{{ route('logout') }}" class="w-full">
            @csrf
            <button type="submit" class="w-full block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Sign out</a>
          </form>
          </li>
        </ul>
      </div>
