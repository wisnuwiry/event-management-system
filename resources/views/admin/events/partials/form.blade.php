    ...
    <div class="mt-4 flex flex-col md:flex-row gap-4">
        ...
        <div class="flex-1 flex flex-col gap-8">
            <div class="flex flex-col">
                <label class="mb-2 text-sm font-medium text-gray-900 dark:text-white" for="date">{{ __('Date') }}</label>
            ...
            <div class="flex flex-col">
                ...
                <div class="flex flex-row gap-2">
                    <div class="flex items-center mb-4">
                        ...
                        >
                        <label for="location-radio-1" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"
                        >Online</label>
                    </div>
